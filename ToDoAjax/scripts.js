...
function displayPost(jsonPost) {
    ...
    deleteBtn.innerHTML = ` <img src="trash.svg" alt="pin">`
    ...
    <p class="post-body">${jsonPost.body}</p></div>
  `;
...
function setAddImportantBtn(btn, postId){
    btn.innerHTML = ` <img src="pinned.svg" alt="pin">`
...
function setRemoveImportantBtn(btn, postId) {
    btn.innerHTML = ` <img src="pin.svg" alt="pin">`
